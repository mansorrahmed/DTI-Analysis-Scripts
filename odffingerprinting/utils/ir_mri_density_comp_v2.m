 function wi = ir_mri_density_comp_v2(kspace, dtype, varargin)
%function wi = ir_mri_density_comp_v2(kspace, dtype, varargin)
%|
...
% Steven Baete, added pipe2-option, Jan 2021, NYU, SOM, CBI/CAI2R
...
case 'pipe2'
	wi = ir_mri_dcf_pipe_v2(kspace, arg.G, arg.arg_pipe{:});
%case 'qian'
